...
<div class="container">
<h1 class="titulo-del-form-titulo">Contactar</h1>
</div>
<form method="POST" action="enviar_mensaje.php">

<div class="form-group">
    <label for="titulo" class="titulo-del-form-container">Nombre:</label>
    <input type="text" name="usuario" placeholder="Usuario" class="contenido-del-articulo-Titulo-U" required>
</div>
<div class="form-group">
    <label for="contenido" class="titulo-del-form-container">Email:</label>
    <textarea type="email" name="mail" placeholder="Email"  class="contenido-del-articulo-Titulo-U" required></textarea>
</div>
<div class="form-group">
    <label for="contenido" class="titulo-del-form-container">Mensaje:</label>
    <textarea name="mensaje" placeholder="Mensaje" class="contenido-del-articulo" required></textarea>
</div>
